...
namespace Gamekit3D
{
    ...
    public class GameObjectTeleporter : MonoBehaviour
    {
        ...
        protected InputManager m_PlayerInput;
        ...
        void Awake()
        {
            ...
            m_PlayerInput = FindObjectOfType<InputManager>();
        }
        ...
        protected IEnumerator Transition(GameObject transitioningGameObject, bool releaseControl, Vector3 destinationPosition, bool fade)
        {
            ...
            if (fade)
            {
                GameManager.Instance.UIController.ChangeState("FadeOut");
            ...
            if (fade)
            {
                GameManager.Instance.UIController.ChangeState("FadeIn");
                yield return new WaitForSeconds(1f);
            }
